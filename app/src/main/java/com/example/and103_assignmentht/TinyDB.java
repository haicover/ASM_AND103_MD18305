...
public class TinyDB {
    ...
    public ArrayList<Fruit> getListObject(String key) {
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Fruit> playerList = new ArrayList<Fruit>();
        for (String jObjString : objStrings) {
            Fruit player = gson.fromJson(jObjString, Fruit.class);
    ...
    public void putListObject(String key, ArrayList<Fruit> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Fruit player : playerList) {
